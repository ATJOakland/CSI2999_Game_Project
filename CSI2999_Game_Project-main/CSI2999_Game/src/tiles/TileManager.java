...
public class TileManager {
	...
	public void getTileImage() {
		try {
			...
			tile[5] = new Tile();
			tile[5].image = ImageIO.read(getClass().getResourceAsStream("/background_tiles/Grey Dirt 16x16.png"));
			
			tile[6] = new Tile();
			tile[6].image = ImageIO.read(getClass().getResourceAsStream("/background_tiles/wall.png"));
		}catch(IOException e) {
			e.printStackTrace();
		}
	}
